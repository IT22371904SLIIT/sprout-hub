...
function AllPost() {
  ...
  const handleAddComment = async (postId) => {
    ...
    if (!content.trim()) {
      alert('A comment cannot me empty.');
      return;
    }
    try {
  ...
  return (
    <div className="modern-container" style={{ background: '#F9FBE7' }}>
            ...
            filteredPosts.map((post) => (
              <div key={post.id} className="post-card" style={{ 
                ...
                <div className="post-header">
                  <div className="user-info">
                    ...
                    <div className="user-details">
                      <p className="username" style={{ color: '#8D6E63' }}>{postOwners[post.userID] || 'Anonymous'}</p>
                      {post.userID !== loggedInUserID && (
                        <button
                          className={followedUsers.includes(post.userID) ? "follow-button following" : "follow-button"}
                          style={{ 
                            background: followedUsers.includes(post.userID) ? '#388E3C' : '#4CAF50',
                            color: 'white'
                          }}
                ...
                <div className="post-content">
                  <h3 className="post-title" style={{ color: '#4CAF50' }}>{post.title}</h3>
                  <p className="post-description" style={{ color: '#8D6E63', whiteSpace: "pre-line" }}>{post.description}</p>
                  <div className="post-category">
                    <span style={{ background: '#C5E1A5', color: '#8D6E63' }}>{post.category || 'Uncategorized'}</span>
                  </div>
                ...
                <div className="post-engagement" style={{ borderTop: '1px solid #C5E1A5' }}>
                  <button 
                ...
                <div className="comment-section" style={{ borderTop: '1px solid #C5E1A5' }}>
      ...
      <Modal
        ...
        style={{
          overlay: { backgroundColor: 'rgba(249, 251, 231, 0.9)' },
          content: { 
            border: '1px solid #C5E1A5',
            background: 'rgba(255, 255, 255, 0.9)'
          }
