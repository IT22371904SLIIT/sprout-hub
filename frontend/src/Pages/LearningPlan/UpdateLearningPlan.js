    ...
    <div className="post-creation-page" style={{ background: '#F9FBE7' }}>
      ...
      <div className="post-creation-container" style={{ 
        ...
        <div className="post-form-card" style={{
          ...
          <h1 className="form-title" style={{ color: '#4CAF50' }}>Update Learning Plan</h1>
          <p className="form-subtitle" style={{ color: '#8D6E63' }}>Refine your learning journey with the community</p>
     ...
     <option value="" disabled>Select Category</option>
            ...
            <div className="template-preview-section">
              ...
              <div className="template-preview-container">
                <div className={`template template-1 ${templateID === 1 ? 'selected' : ''}`} style={{
                  border: '1px solid #C5E1A5',
                  background: 'rgba(255, 255, 255, 0.9)'
                }}>
                ...
                <div className={`template template-2 ${templateID === 2 ? 'selected' : ''}`} style={{
                  border: '1px solid #C5E1A5',
                  background: 'rgba(255, 255, 255, 0.9)'
                }}>
                ...
                <div className={`template template-3 ${templateID === 3 ? 'selected' : ''}`} style={{
                  border: '1px solid #C5E1A5',
                  background: 'rgba(255, 255, 255, 0.9)'
                }}>
